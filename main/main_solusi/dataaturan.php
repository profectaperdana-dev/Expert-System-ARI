...
?>
<div class='judul'><h2>DATA RULE PER PENYAKIT </h2></div>
<table class="in" width="100%" border="0" cellspacing="1" cellpadding="3">
  <tr>
    <td width="1%" bgcolor="#f5f5f5"><strong>No</strong></td>
    <td width="20%" bgcolor="#f5f5f5"><strong>PENYAKIT</strong></td>
    <td width="30%" bgcolor="#f5f5f5"><strong>GEJALA</strong></td>
  </tr>
<?php
...
?>
  <tr  bgcolor="<?php echo $warna; ?>">
	...
	<table class="in" width="100%" border="0" cellspacing="1" cellpadding="2">
      <tr>
        <td width="1%" bgcolor="#f5f5f5"><b>No</b></td>
        <td width="10%" bgcolor="#f5f5f5"><b>Kode </b></td>
        <td width="20%" bgcolor="#f5f5f5"><b>Nama Gejala</b></td>
        <td width="10%" bgcolor="#f5f5f5"><strong>Probabilitas (%)</strong></td>
        </tr>
      <?php
	  // Menampilkan daftar aturan
